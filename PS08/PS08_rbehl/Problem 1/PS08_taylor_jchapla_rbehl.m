function [counter, Taylor_cos, difference] = PS08_taylor_jchapla_rbehl(x,tolerance)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ENGR 132 
% Program Description 
...
% PS08_taylor_jchapla_rbehl(0.5,3)
